...
namespace Frontend
{
    ...
    public partial class DefaultGui : Form
    {
        ...
        private GameManager gameManager = new GameManager("1", 1024);
        ...
        private void board_PaintMap(object sender, System.Windows.Forms.PaintEventArgs e) {
            try
            {
                ...
                {
                    for (int j = 0; j < fields.GetLength(i); j++)
                    {
                        this.drawMapTile(buffer.Graphics, fields[i, j], i * tileSize.Width, j * tileSize.Height, tileSize.Width, tileSize.Height);
                    }
                }
                buffer.Render();
            }
        ...
        protected void drawMapTile(Graphics g, Field field, int absX, int absY, int width, int height)
        {
        ...
        protected void drawPlayer(Graphics g, Player player)
        {
            Size tileSize = this.getTileSize();
        ...
        protected void drawDragon(Graphics g, Dragon dragon)
        {
            Size tileSize = this.getTileSize();
        ...
        protected Size getTileSize()
        {
            ...
            int cellWidth = this.board.Size.Width / width;
            int cellHeight = this.board.Size.Height / height;
